              ...
              <div class="add-form">
                <a class="form-group font-weight-bold" href="{{route('adminpage.setfoodadmin.adminsetfood')}}"><-กลับไป</a>
                    <div class="text-center">
                      <h1 class="h4 text-gray-700 mb-4 font-weight-bold">เพิ่มเมนูเช็ตอาหาร</h1>
                    </div>
                    <form class="font-weight-bold" method="POST" action="{{route('adminpage.setfoodadmin.adminsetfoodadd')}}" enctype="multipart/form-data">
                      @csrf
